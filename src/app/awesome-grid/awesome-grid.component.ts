...
@Component({
  ...
  templateUrl: './awesome-grid.component.html',
  styleUrls: ['./awesome-grid.component.scss']
})
export class AwesomeGridComponent implements OnInit, OnDestroy, AfterViewInit {
